...
export const TRANSLATIONS: Record<Locale, TranslationContent> = {
  "pt-BR": {
    ...
    projects: [
      ...
      },
      {
        ...
        description:
          "Use este espaco para mostrar dominio tecnico e pensamento de produto.",
        bullets: [
      ...
      },
      {
        ...
        description:
          "Mostre como voce entrega valor de forma pragmatica e sustentavel.",
        bullets: [
  ...
  en: {
    ...
    hero: {
      ...
      email: "sanderhus15@outlook.com",
      about: [
        "I am a Back-End Developer focused on .NET/C# and passionate about building robust, scalable, and high-performance solutions.",
        "I am currently part of the Code n'App team, where I work on the development and maintenance of modern applications using .NET 6/8, ASP.NET Core, and best practices such as Clean Architecture, DDD, and Repository Pattern.",
        "I have solid experience in creating and optimizing RESTful APIs, database management with SQL Server, Entity Framework, and Dapper, as well as hands-on experience in DevOps environments with Docker, Kubernetes, AWS, and CI/CD pipelines in Azure DevOps.",
      ],
    },
    actions: {
    ...
    projects: [
      ...
      },
      {
        ...
        description:
          "Use this space to demonstrate technical depth and product thinking.",
        bullets: [
  ...
  es: {
    ...
    projects: [
      ...
      },
      {
        ...
        description:
          "Usa este espacio para mostrar profundidad tecnica y vision de producto.",
        bullets: [
      ...
      },
      {
        ...
        description:
          "Muestra como entregas valor de forma practica y sostenible.",
        bullets: [
